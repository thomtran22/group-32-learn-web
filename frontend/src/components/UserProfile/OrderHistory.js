// file: src/components/UserProfile/OrderHistory.js
...
// Import các components con (Lưu ý chỉnh đường dẫn import cho đúng vị trí file của bạn)
// Giả sử các file này đang nằm ở folder components/Order
...
import ShippingInformation from "../ShippingInformation"; // Component hiển thị chi tiết cũ
...
const OrderHistory = () => {
  ...
  // 3. Các hành động (Cancel, Receive)
  ...
  // 4. Xử lý Xem chi tiết (Chuyển View thay vì Navigate)
  ...
  return (
    <div className="order-history-container" style={{ fontFamily: "Arial, sans-serif" }}>
      ...
      {/* VIEW: DANH SÁCH (Giao diện giống hệt Orders.js cũ) */}
      {view === "list" && (
        <>
          {/* Tabs */}
            ...
            <div className="order-list">
                {filteredOrders.map((order) => (
                    <OrderCard 
                        ...
                        // QUAN TRỌNG: Truyền hàm này để chặn navigate mặc định
      ...
      {/* VIEW: CHI TIẾT (Logic cũ của OrderHistory) */}
      {view === "detail" && (
        <div className="order-detail-view">
            ...
            {loading ? (
                ...
                // Reuse component ShippingInformation bạn đã có
